...
const routes: Routes = [
  ...
  {path:"dashboard/services", component:AllRestaurantsComponent, canActivate:[AuthGuard]},
  {path:"dashboard/services/edit/:id", component:RestaurantItemComponent, canActivate:[AuthGuard]},
  {path:"dashboard/services/add", component:AddRestaurantComponent, canActivate:[AuthGuard]},
